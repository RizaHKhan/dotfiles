...
cp -r /home/khanr/.config/opencode/context ~/.opencode/
```
...
**Context-aware:** Agents automatically load patterns from `/home/khanr/.config/opencode/context/` to follow your coding standards.
...
nano ~//home/khanr/.config/opencode/context/project/project-context.md
...
```
"Load context from /home/khanr/.config/opencode/context/ then help me create a new agent"
```
...
A: Edit `~//home/khanr/.config/opencode/context/project/project-context.md` - agents automatically load this file.
