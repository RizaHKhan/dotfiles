...
- Code tasks → /home/khanr/.config/opencode/context/core/standards/code-quality.md (MANDATORY)
```
...
**Path normalization**:
```
File path:     /home/khanr/.config/opencode/context/core/standards/code-quality.md
...
```
dependencies:
  - context:core/standards/code           # /home/khanr/.config/opencode/context/core/standards/code-quality.md
  - context:core/standards/docs           # /home/khanr/.config/opencode/context/core/standards/documentation.md
  - context:core/workflows/delegation     # /home/khanr/.config/opencode/context/core/workflows/task-delegation.md
...
- context:core/standards/code (referenced 3 times)
  - Line 64: "Code tasks → /home/khanr/.config/opencode/context/core/standards/code-quality.md"
...
```bash
# Make your changes
vim /home/khanr/.config/opencode/context/core/standards/code-quality.md
```
...
ls -la /home/khanr/.config/opencode/context/core/standards/code-quality.md
...
rm /home/khanr/.config/opencode/context/core/standards/code-analysis.md
./scripts/registry/auto-detect-components.sh --auto-add
```
...
- **Registry Guide**: `/home/khanr/.config/opencode/context/openagents-repo/guides/updating-registry.md`
- **Registry Concepts**: `/home/khanr/.config/opencode/context/openagents-repo/core-concepts/registry.md`
- **Adding Agents**: `/home/khanr/.config/opencode/context/openagents-repo/guides/adding-agent.md`
