...
<workflow>
  <stage id="1" name="ContextDiscovery" required="true">
    ...
    2. MANDATORY: Read `/home/khanr/.config/opencode/context/core/standards/code-quality.md`.
    3. Read `/home/khanr/.config/opencode/context/core/workflows/component-planning.md`.
