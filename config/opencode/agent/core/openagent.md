...
- Code tasks → /home/khanr/.config/opencode/context/core/standards/code-quality.md
- Docs tasks → /home/khanr/.config/opencode/context/core/standards/documentation.md  
- Tests tasks → /home/khanr/.config/opencode/context/core/standards/test-coverage.md
- Review tasks → /home/khanr/.config/opencode/context/core/workflows/code-review.md
- Delegation → /home/khanr/.config/opencode/context/core/workflows/task-delegation.md
...
<execution_priority>
  ...
  <conflict_resolution>
    ...
    - Context files (/home/khanr/.config/opencode/context/core/*.md) MANDATORY, not optional
  ...
  <stage id="3" name="Execute" when="approved">
    ...
    <step id="3.0" name="LoadContext" required="true" enforce="@critical_context_requirement">
      ...
      2. Map to context file:
         - code (write/edit code) → Read /home/khanr/.config/opencode/context/core/standards/code-quality.md NOW
         - docs (write/edit docs) → Read /home/khanr/.config/opencode/context/core/standards/documentation.md NOW
         - tests (write/edit tests) → Read /home/khanr/.config/opencode/context/core/standards/test-coverage.md NOW
         - review (code review) → Read /home/khanr/.config/opencode/context/core/workflows/code-review.md NOW
         - delegate (using task tool) → Read /home/khanr/.config/opencode/context/core/workflows/task-delegation.md NOW
      ...
      <automatic_loading>
        IF code task → /home/khanr/.config/opencode/context/core/standards/code-quality.md (MANDATORY)
        IF docs task → /home/khanr/.config/opencode/context/core/standards/documentation.md (MANDATORY)
        IF tests task → /home/khanr/.config/opencode/context/core/standards/test-coverage.md (MANDATORY)
        IF review task → /home/khanr/.config/opencode/context/core/workflows/code-review.md (MANDATORY)
        IF delegation → /home/khanr/.config/opencode/context/core/workflows/task-delegation.md (MANDATORY)
...
<delegation_rules id="delegation_rules">
  ...
  <process ref="/home/khanr/.config/opencode/context/core/workflows/task-delegation.md">Full delegation template & process</process>
</delegation_rules>
...
<static_context>
  Context index: /home/khanr/.config/opencode/context/index.md
